...
class testCity(unittest.TestCase):
    ...
    def test_city_save_parameters(self):
        """test save parameter"""
        b1 = City()
    ...
    def test_city_class_state_id(self):
        """check the class attr state_id in City"""
        self.assertEqual(str, type(City.state_id))

    def test_city_class_name(self):
        """check the class attr name in City"""
    ...
    def test_city_to_dict_parameters(self):
